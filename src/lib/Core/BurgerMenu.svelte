...
<!-- <button
	...
	onclick={doubleClick}
	class="btn btn-square absolute right-0 bottom-0 m-2 {!hide || edit.edit
		? 'opacity-100'
		: 'opacity-0 hover:opacity-100'} "
>
    <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" viewBox="0 0 24 24"><path fill="currentColor" d="M22 13c0 1.11-.89 2-2 2H4a2 2 0 1 1 0-4h9l2.5 2l2.5-2h2a2 2 0 0 1 2 2M12 3C3 3 3 9 3 9h18s0-6-9-6M3 18c0 1.66 1.34 3 3 3h12c1.66 0 3-1.34 3-3v-1H3z"/></svg>
</button> -->
...
>
	...
	<ul
		tabindex="0"
		class="dropdown-content menu bg-base-100 rounded-box z-[1] shadow [&>li]:m-1"
